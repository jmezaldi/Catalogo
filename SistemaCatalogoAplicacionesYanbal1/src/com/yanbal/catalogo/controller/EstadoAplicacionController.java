...
import com.yanbal.catalogo.ejb.EstadoAplicacionFacade;
...
@ManagedBean(name = "estadoAplicacionController")
@SessionScoped
public class EstadoAplicacionController implements Serializable {

	private EstadoAplicacion current;
	private DataModel items = null;
	@EJB
	private com.yanbal.catalogo.ejb.EstadoAplicacionFacade ejbFacade;
	@EJB
	private com.yanbal.catalogo.ejb.UsuarioFacade ejbFacadeUsuario;
	private PaginationHelper pagination;
	private int selectedItemIndex;

	private List<EstadoAplicacion> filteredItems;
	UtilController util = new UtilController();
	private FacesContext fCtx;

	public EstadoAplicacionController() {
	}

	public EstadoAplicacion getSelected() {
		if (current == null) {
			current = new EstadoAplicacion();
			selectedItemIndex = -1;
		}
		return current;
	}

	private EstadoAplicacionFacade getFacade() {
		return ejbFacade;
	}
	...
	public String prepareView() {
		current = (EstadoAplicacion) getItems().getRowData();
	...
	public String create() {
		...
		try {
			...
			JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle")
					.getString("EstadoAplicacionCreated"));
	...
	public String update() {
		...
		try {
			...
			JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle")
					.getString("EstadoAplicacionUpdated"));
			util.sendEmailAccounts(email,ejbFacadeUsuario.findAll(),
	...
	private void performDestroy() {
		...
		try {
			...
			JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle")
					.getString("EstadoAplicacionDeleted"));
			util.sendEmailAccounts(email,ejbFacadeUsuario.findAll(),
	...
	public DataModel getItems() {
		if (items == null) {
			...
			filteredItems = new ArrayList<EstadoAplicacion>(ejbFacade.findAll());
		}
		return items;
	}
	...
	public static class EstadoAplicacionControllerConverter implements
			Converter {
		...
		public Object getAsObject(FacesContext facesContext,
			...
			EstadoAplicacionController controller = (EstadoAplicacionController) facesContext
					.getApplication()
					.getELResolver()
					.getValue(facesContext.getELContext(), null,
							"estadoAplicacionController");
		...
		public String getAsString(FacesContext facesContext,
			...
			if (object instanceof EstadoAplicacion) {
				EstadoAplicacion o = (EstadoAplicacion) object;
				return getStringKey(o.getId());
			} else {
				throw new IllegalArgumentException("object " + object
						+ " is of type " + object.getClass().getName()
						+ "; expected type: "
						+ EstadoAplicacionController.class.getName());
			}
		}
	}

	public String prepareEditCust(EstadoAplicacion obj) {
		current = obj;
		selectedItemIndex = pagination.getPageFirstItem()
				+ getItems().getRowIndex();
		return "Edit";
	...
	public String destroyCust(EstadoAplicacion obj) {
	...
	public List<EstadoAplicacion> getFilteredItems() {
		return filteredItems;
	}

	public void setFilteredItems(List<EstadoAplicacion> filteredItems) {
