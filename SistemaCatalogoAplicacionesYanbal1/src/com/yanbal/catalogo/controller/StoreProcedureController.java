...
@ManagedBean(name = "storeProcedureController")
@SessionScoped
public class StoreProcedureController implements Serializable {

	private StoreProcedure current;
	private DataModel items = null;
	@EJB
	private com.yanbal.catalogo.ejb.StoreProcedureFacade ejbFacade;
	@EJB
	private com.yanbal.catalogo.ejb.UsuarioFacade ejbFacadeUsuario;
	private PaginationHelper pagination;
	private int selectedItemIndex;

	private List<StoreProcedure> filteredItems;
	...
	public StoreProcedure getSelected() {
		if (current == null) {
			current = new StoreProcedure();
			selectedItemIndex = -1;
		}
		return current;
	}

	private StoreProcedureFacade getFacade() {
		return ejbFacade;
	}
	...
	public String prepareView() {
		current = (StoreProcedure) getItems().getRowData();
	...
	public String create() {
		...
		try {
			...
			JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle")
					.getString("StoreProcedureCreated"));
	...
	public String update() {
		...
		try {
			...
			JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle")
					.getString("StoreProcedureUpdated"));
			util.sendEmailAccounts(email,ejbFacadeUsuario.findAll(),
	...
	private void performDestroy() {
		...
		try {
			...
			JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle")
					.getString("StoreProcedureDeleted"));
			util.sendEmailAccounts(email,ejbFacadeUsuario.findAll(),
	...
	public DataModel getItems() {
		if (items == null) {
			...
			filteredItems = new ArrayList<StoreProcedure>(ejbFacade.findAll());
		}
		return items;
	}
	...
	@FacesConverter(forClass = StoreProcedure.class)
	public static class StoreProcedureControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext,
			...
			StoreProcedureController controller = (StoreProcedureController) facesContext
					.getApplication()
					.getELResolver()
		...
		public String getAsString(FacesContext facesContext,
			...
			if (object instanceof StoreProcedure) {
				StoreProcedure o = (StoreProcedure) object;
				return getStringKey(o.getId());
			} else {
				throw new IllegalArgumentException("object " + object
						+ " is of type " + object.getClass().getName()
						+ "; expected type: "
						+ StoreProcedureController.class.getName());
			}
		}
	}

	public String prepareEditCust(StoreProcedure obj) {
		current = obj;
		selectedItemIndex = pagination.getPageFirstItem()
				+ getItems().getRowIndex();
		return "Edit";
	...
	public String destroyCust(StoreProcedure obj) {
	...
	public List<StoreProcedure> getFilteredItems() {
		return filteredItems;
	}

	public void setFilteredItems(List<StoreProcedure> filteredItems) {
