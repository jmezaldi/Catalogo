...
import com.yanbal.catalogo.ejb.ExcepcionFacade;
...
@ManagedBean(name = "excepcionController")
@SessionScoped
public class ExcepcionController implements Serializable {

	private Excepcion current;
	private DataModel items = null;
	@EJB
	private com.yanbal.catalogo.ejb.ExcepcionFacade ejbFacade;
	@EJB
	private com.yanbal.catalogo.ejb.UsuarioFacade ejbFacadeUsuario;
	private PaginationHelper pagination;
	private int selectedItemIndex;

	private List<Excepcion> filteredItems;
	...
	public Excepcion getSelected() {
		if (current == null) {
			current = new Excepcion();
			selectedItemIndex = -1;
		}
		return current;
	}

	private ExcepcionFacade getFacade() {
		return ejbFacade;
	}
	...
	public String prepareView() {
		current = (Excepcion) getItems().getRowData();
	...
	public DataModel getItems() {
		if (items == null) {
			...
			filteredItems = new ArrayList<Excepcion>(ejbFacade.findAll());
		}
		return items;
	}
	...
	@FacesConverter(forClass = Excepcion.class)
	public static class ExcepcionControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext,
			...
			ExcepcionController controller = (ExcepcionController) facesContext
					.getApplication()
					.getELResolver()
	...
	public String prepareEditCust(Excepcion obj) {
		current = obj;
		selectedItemIndex = pagination.getPageFirstItem()
				+ getItems().getRowIndex();
		return "Edit";
	...
	public String destroyCust(Excepcion obj) {
	...
	public List<Excepcion> getFilteredItems() {
		return filteredItems;
	}

	public void setFilteredItems(List<Excepcion> filteredItems) {
