...
import com.yanbal.catalogo.ejb.SoftwareBaseFacade;
...
@ManagedBean(name = "softwareBaseController")
@SessionScoped
public class SoftwareBaseController implements Serializable {

	private SoftwareBase current;
	private DataModel items = null;
	@EJB
	private com.yanbal.catalogo.ejb.SoftwareBaseFacade ejbFacade;
	@EJB
	private com.yanbal.catalogo.ejb.UsuarioFacade ejbFacadeUsuario;
	private PaginationHelper pagination;
	private int selectedItemIndex;

	private List<SoftwareBase> filteredItems;
	UtilController util = new UtilController();
	private FacesContext fCtx;

	public SoftwareBaseController() {
	}

	public SoftwareBase getSelected() {
		if (current == null) {
			current = new SoftwareBase();
			selectedItemIndex = -1;
		}
		return current;
	}

	private SoftwareBaseFacade getFacade() {
		return ejbFacade;
	}
	...
	public String prepareView() {
		current = (SoftwareBase) getItems().getRowData();
	...
	public DataModel getItems() {
		if (items == null) {
			...
			filteredItems = new ArrayList<SoftwareBase>(ejbFacade.findAll());
		}
		return items;
	}
	...
	@FacesConverter(forClass = SoftwareBase.class)
	public static class SoftwareBaseControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext,
			...
			SoftwareBaseController controller = (SoftwareBaseController) facesContext
					.getApplication()
					.getELResolver()
					.getValue(facesContext.getELContext(), null,
							"softwareBaseController");
		...
		public String getAsString(FacesContext facesContext,
			...
			if (object instanceof SoftwareBase) {
				SoftwareBase o = (SoftwareBase) object;
				return getStringKey(o.getId());
			} else {
				throw new IllegalArgumentException("object " + object
						+ " is of type " + object.getClass().getName()
						+ "; expected type: "
						+ SoftwareBaseController.class.getName());
			}
		}
	}

	public String prepareEditCust(SoftwareBase obj) {
		current = obj;
		selectedItemIndex = pagination.getPageFirstItem()
				+ getItems().getRowIndex();
		return "Edit";
	...
	public String destroyCust(SoftwareBase obj) {
	...
	public List<SoftwareBase> getFilteredItems() {
		return filteredItems;
	}

	public void setFilteredItems(List<SoftwareBase> filteredItems) {
