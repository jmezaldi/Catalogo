...
import com.yanbal.catalogo.ejb.ServidorFacade;
...
public class ServidorController implements Serializable {
	...
	@EJB
	private com.yanbal.catalogo.ejb.ServidorFacade ejbFacade;
	@EJB
	private com.yanbal.catalogo.ejb.UsuarioFacade ejbFacadeUsuario;
	private PaginationHelper pagination;
	private int selectedItemIndex;

	private List<Servidor> filteredItems;
	...
	public DataModel getItems() {
		if (items == null) {
			...
			filteredItems = new ArrayList<Servidor>(ejbFacade.findAll());
		}
		return items;
	}
	...
	public static class ServidorControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext,
			...
			ServidorController controller = (ServidorController) facesContext
					.getApplication()
					.getELResolver()
		...
		public String getAsString(FacesContext facesContext,
			...
			if (object instanceof Servidor) {
				...
				throw new IllegalArgumentException("object " + object
						...
						+ "; expected type: "
						+ ServidorController.class.getName());
			}
		}
	}

	public String prepareEditCust(Servidor obj) {
		current = obj;
		selectedItemIndex = pagination.getPageFirstItem()
				+ getItems().getRowIndex();
		return "Edit";
	...
	public String destroyCust(Servidor obj) {
	...
	public List<Servidor> getFilteredItems() {
		return filteredItems;
	}

	public void setFilteredItems(List<Servidor> filteredItems) {
