...
import com.yanbal.catalogo.ejb.AmbienteFacade;
...
public class AmbienteController implements Serializable {
	...
	@EJB
	private com.yanbal.catalogo.ejb.AmbienteFacade ejbFacade;
	@EJB
	private com.yanbal.catalogo.ejb.UsuarioFacade ejbFacadeUsuario;
	private PaginationHelper pagination;
	private int selectedItemIndex;

	private List<Ambiente> filteredAmbiente;
	...
	public DataModel getItems() {
		if (items == null) {
			...
			filteredAmbiente = new ArrayList<Ambiente>(ejbFacade.findAll());
	...
	public static class AmbienteControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext,
			...
			AmbienteController controller = (AmbienteController) facesContext
					.getApplication()
					.getELResolver()
		...
		public String getAsString(FacesContext facesContext,
			...
			if (object instanceof Ambiente) {
				...
				throw new IllegalArgumentException("object " + object
						...
						+ "; expected type: "
						+ AmbienteController.class.getName());
			}
		}
	}

	public String prepareEditCust(Ambiente obj) {
		current = obj;
		selectedItemIndex = pagination.getPageFirstItem()
				+ getItems().getRowIndex();
		return "Edit";
	...
	public String destroyCust(Ambiente obj) {
	...
	public List<Ambiente> getFilteredAmbiente() {
		return filteredAmbiente;
	}

	public void setFilteredAmbiente(List<Ambiente> filteredAmbiente) {
		this.filteredAmbiente = filteredAmbiente;
	}
